...
It is written purely in **JavaScript** and does not one of the Framework wrappers.
...
Now navigate to [http://localhost:5173/](http://localhost:5173/) in order the see AdapTable in action.
